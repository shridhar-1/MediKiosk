    ...
    <main className="kiosk-bezel min-h-screen px-5 py-8">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-4 max-w-lg text-[#f6f0e4]/75">
          Patients own their history. Clinicians read it in seconds. Select your secure portal below to continue.
        </p>
          ...
          {doors.map((d) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <span className="mt-4 inline-block text-sm font-medium text-[#0f5c61]">Continue &rarr;</span>
              </div>
            </Link>
          ))}
        </div>
